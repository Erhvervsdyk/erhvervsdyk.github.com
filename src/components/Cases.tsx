...
export function Cases() {
  ...
  const cases = [
    ...
    {
      title: "Assistere bjærgning af skib med Luckow Marine",
      description:
        "Inspektion efter forlis, afpropning af skib og miljøhensyn. Efterfølgende assisteret bjærgning af skib. ",
